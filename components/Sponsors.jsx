    ...
    >
      ...
      >
        ...
        <div className="relative z-10 flex flex-col gap-10 items-center">
          {/* Title Sponsor */}
          <div className="p-4 rounded-2xl bg-gradient-to-br from-[#814769] to-[#9e7a4a] text-white shadow-lg w-[240px] h-[180px] flex flex-col items-center justify-center hover:shadow-sm hover:scale-[1.02] transition-all duration-300">            
