...
const About = () => {
  ...
  return (
    <section
      id="about"
      className="min-h-screen bg-custom-dark text-white flex items-center justify-center relative p-8 bg-pattern font-satoshi -mt-40 sm:-mt-48 px-10 -mb-20 md:-mt-0 lg:-mt-0"
    >
      {/* Background Image */}
