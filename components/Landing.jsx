...
const Landing = () => {
  ...
  return (
    ...
    />
        ...
        <Image
  className={`brightness-125 absolute bottom-0 right-0 z-10 transform transition-transform duration-1000 ${isLoaded ? 'translate-x-0' : 'translate-x-[100%]'}
    w-[250px] h-[250px] mb-[-120px] mr-[-10px]
...
/>
        ...
        <Image
          className={`brightness-125 absolute bottom-0  z-50  transform transition-transform duration-1000 ${isLoaded ? 'translate-x-0' : '-translate-x-[100%]'}
              w-[190px] h-[250px] mb-[-20px] ml-[10px]
    ...
    lg:w-[320px] lg:h-[500px] lg:mb-[-100px] lg:ml-[60px]`}
        ...
        />
        <Image
          className={`brightness-125 absolute bottom-0  z-50  transform transition-transform duration-1000 ${isLoaded ? 'translate-x-0' : '-translate-x-[100%]'}                    w-[190px] h-[250px] mb-[-20px] ml-[10px]
     // w-[60px] h-[150px] mb-[54px] ml-[95px]
    ...
    lg:w-[150px] lg:h-[150px] lg:mb-[-10px] lg:ml-[160px]`}
        ...
        {/* Main Logo Image */}
        <Image
          className={`brightness-125 w-auto h-[610px] relative flex z-10 mx-auto transition-all duration-700 ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-[100px] opacity-0'}
              mb-[170px] 
sm:mb-[60px] 
 md:mb-[20px] 
    lg:mb-[-80px]`}
      ...
      <button
        className="absolute bottom-[10%] left-1/2 transform -translate-x-1/2 px-6 py-3 text-xl font-bold text-white bg-[#0d0714] rounded-lg border-2 border-transparent  hover:border-white hover:shadow-lg transition-all hover:scale-105 
